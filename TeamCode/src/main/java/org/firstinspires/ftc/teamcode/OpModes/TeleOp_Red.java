...
public class TeleOp_Red extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Outtake outtake=new Outtake(Turret.State.RED);
        ...
        while(opModeIsActive())
        {
            ...
            if(Sorter.state== Sorter.State.GoingReadyForTransfer)gamepad1.rumble(1000);
            ...
            if(gamepad1.b && Sorter.state!=Sorter.State.ReadyForTransfer && Sorter.state!=Sorter.State.GoingReadyForTransfer && Sorter.state!=Sorter.State.BeforeReset && Sorter.state!=Sorter.State.FastShooting)
            ...
            telemetry.addData("Rapid shoot timer", outtake.distance);
            telemetry.addData("POSITION" , outtake.position);
            telemetry.addData( "a" , Math.abs(outtake.distance-(outtake.position+10)*100));
